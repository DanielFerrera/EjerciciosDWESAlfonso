...
echo "<h2> EJERCICIO 5 DE VARIABLES Y DE SUS CONVERSIONES</h2>";

 $a1=347; $b1=((real)347); echo gettype($a1)." "; echo gettype($b1)." ". $b1."<br/>" ;
 $a2=2147483647; $b2=((double)2147483647); echo gettype($a2)." "; echo gettype($b2)." ". $b2."<br/>";
 $a3=-2147483647; $b3=((double)2147483647); echo gettype($a2)." "; echo gettype($b2)." ". $b3."<br/>";
 $a4=23.7678; $b4=((int)23.7678); echo gettype($a4)." ".$a4; echo gettype($b4)."<br/>";
 $a5=3.1416;  $b5=((integer)3.1416); echo gettype($a5)." "; echo gettype($b5)."<br/>";
 $a6="347"; $b6=((double)"347"); echo gettype($a6)." "; echo gettype($b6)."<br/>";
 $a7="3.1416"; $b7=((integer)"3.1416"); echo gettype($a6)." "; echo gettype($b6).$b7."<br/><br/><br/>";
...
echo "<br/>";
echo "mi ejemplillo <br/>";
$a1=3.45234;  echo "$a1 es un numero ". gettype($a1);
