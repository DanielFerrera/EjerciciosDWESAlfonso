...
function altacliente($nifvalidado,$nombre,$apellido,$cp,$direccion,$ciudad,$conexion){
      try {
        $sql = "INSERT INTO cliente VALUES ('$nifvalidado','$nombre','$apellido','$cp','$direccion','$ciudad')";
        $conexion->exec($sql);
